...
class Subscriber:
    ...
    def run(self):
        ...
        #---- kong ----
        sub.setsockopt_string(zmq.SUBSCRIBE, self.reboot)
        sub.setsockopt_string(zmq.SUBSCRIBE, self.screenOff)
        sub.setsockopt_string(zmq.SUBSCRIBE, self.screenOn)
        sub.setsockopt_string(zmq.SUBSCRIBE, self.clearCache)
        sub.setsockopt_string(zmq.SUBSCRIBE, self.clearContent)
